...
namespace ElectroTech.Web.Service
{
    public class ViewRenderService : IViewRenderService
    {
        ...
        public async Task<string> RenderViewToStringAsync<T>(string pageName, T model, ViewDataDictionary viewDictionary = null)
        {
            var actionContext =
                new ActionContext(
                    _httpContext.HttpContext,
            ...
            {
                viewDictionary = new ViewDataDictionary<T>(new EmptyModelMetadataProvider(), new ModelStateDictionary())
                {
                    Model = model,
            ...
            //if (viewData != null)
            //{
            //    foreach (KeyValuePair<string, object> kv in (viewData as IDictionary<string, object>))
            //    {
        ...
        public async Task<string> RenderViewnoModelToStringAsync(string pageName, ViewDataDictionary viewDictionary = null)
        {
            var actionContext =
                new ActionContext(
                    _httpContext.HttpContext,
